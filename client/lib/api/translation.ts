...
export const useTranslation = () => {
    ...
    useEffect(() => {
        if (user && detectedLoc && isAuto) {
            ...
            const needsSync = !s ||
                ...
                s.country_code !== detectedLoc.countryCode ||
            ...
            if (needsSync) {
                updateSettings(user.id, {
                    ...
                    country_code: detectedLoc.countryCode,
    ...
    const currencySymbol = (settings as any)?.currency_symbol || detectedLoc?.currencySymbol || currencySymbols[currency] || '$';
